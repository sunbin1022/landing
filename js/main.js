$(function(){
	$('nav li').eq(0).click(function(){
		$('html,body').animate({scrollTop:$('#div1').offset().top-58}, 800);
	})
	$('nav li').eq(1).click(function(){
		$('html,body').animate({scrollTop:$('#div4').offset().top-58}, 800);
	})
	$('nav li').eq(2).click(function(){
		$('html,body').animate({scrollTop:$('#div5').offset().top-58}, 800);
	})
	$('nav li').eq(3).click(function(){
		$('html,body').animate({scrollTop:$('#div6').offset().top-58}, 800);
	})
...
$('.list  li').click(function(){
	...
	$(this).parent('ul').siblings('.tabdiv').eq(index).addClass('active').siblings('.tabdiv').removeClass('active')
})
